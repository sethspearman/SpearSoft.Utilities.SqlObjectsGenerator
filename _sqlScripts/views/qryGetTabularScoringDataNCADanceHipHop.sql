...
if object_id(dbo.qryGetTabularScoringDataNCADanceHipHop) is not null
	drop view dbo.qryGetTabularScoringDataNCADanceHipHop
...
-- grant execute on qryGetTabularScoringDataNCADanceHipHop to myUser
