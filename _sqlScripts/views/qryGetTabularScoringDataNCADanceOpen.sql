...
if object_id(dbo.qryGetTabularScoringDataNCADanceOpen) is not null
	drop view dbo.qryGetTabularScoringDataNCADanceOpen
...
-- grant execute on qryGetTabularScoringDataNCADanceOpen to myUser
