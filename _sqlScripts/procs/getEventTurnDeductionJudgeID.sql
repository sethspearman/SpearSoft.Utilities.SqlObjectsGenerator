...
if object_id(dbo.getEventTurnDeductionJudgeID) is not null
	drop procedure dbo.getEventTurnDeductionJudgeID
...
-- grant execute on getEventTurnDeductionJudgeID to myUser
