...
if object_id(dbo.usp_UpdateEventTurnJudgeScoreRanges2) is not null
	drop procedure dbo.usp_UpdateEventTurnJudgeScoreRanges2




CREATE PROCEDURE [dbo].[usp_UpdateEventTurnJudgeScoreRanges2]
...
-- grant execute on usp_UpdateEventTurnJudgeScoreRanges2 to myUser
